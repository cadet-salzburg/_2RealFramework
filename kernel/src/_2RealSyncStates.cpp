...
#include "_2RealAbstractSyncState.h"
...
namespace _2Real
{
	...
	void SyncStates::inletAdded(InputSlot &slot, AbstractInletBasedTrigger &trigger)
	{
		//sync has no inlets
	}

	void SyncStates::inletRemoved(InputSlot &slot)
	{
		//sync has no inlets
	}
