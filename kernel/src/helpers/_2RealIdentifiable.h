...
namespace _2Real
{
	...
	template< >
	class Identifiable< OutletIO > : public AbstractIdentifiable
	{
	protected:
	...
	template< >
	class Identifiable< AbstractInletIO > : public AbstractIdentifiable
	{
	protected:
	...
	template< >
	class Identifiable< ParameterIO > : public AbstractIdentifiable
	{
	protected:
