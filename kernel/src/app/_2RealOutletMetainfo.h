...
namespace _2Real
{
	...
	namespace app
	{
		class OutletMetainfo : public IoSlotMetainfo
		{

		public:

			OutletMetainfo();
			explicit OutletMetainfo( std::shared_ptr< const SharedServiceOutletMetainfo > );
		...
		private:
			...
			std::weak_ptr< const SharedServiceOutletMetainfo >		mImpl;
