...
namespace _2Real
{
	...
	PluginContext::PluginContext(PluginContext const& _src) : m_PluginPtr(_src.m_PluginPtr)
	{
	}
	...
	void PluginContext::registerSingleton(std::string const& _name, ServiceCreator _creator)
	{
