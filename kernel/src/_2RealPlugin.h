...
namespace _2Real
{
	...
	typedef std::multimap< std::string, IService * >				ServiceMap;
	...
	public:
		...
		Plugin(std::string const& name, IPluginActivator &activator, PluginMetadata &metadata);
		~Plugin();
		...
		*/
		ServiceData						createService(std::string const& serviceName);
