...
namespace _2Real
{
	...
	public:
		...
		*/
		...
		/*
		*	function for the lazy marius
		*	returns the identifier of either a new instance of className, or the singleton instance of className
		...
		*	if libraryPath is relative, it will be interpreted with respect to the base directory
		*	the name of the returned identifier will be autogenerated
		*/
		const Identifier createInstance(std::string const& className, std::string const& libraryPath);
