	...
	*/
	...
	public:
		...
		*/
		...
		/**
		*	begins configuration of output container with _type as top level container
		*/
		const bool beginConfiguration(eContainerType const& _type, ErrorState &_error = ErrorState());

		/**
		*	begins configuration of output container
		*/
		const bool beginConfiguration(ErrorState &_error = ErrorState());

		/**
		*	ends configuration of output container & checks if configuration is valid
		*/
		const bool endConfiguration(ErrorState &_error = ErrorState());
		...
		*/
		...
		/**
		*	ends configuration of current group container & checks if configuration is valid
		*/
		...
		*/
		const bool beginServiceConfiguration(std::string const& _name, std::string const& _plugin, ErrorState &_error = ErrorState());

		/**
		*	ends configuration of user service
		*/
		const bool endServiceConfiguration(ErrorState &_error = ErrorState());
	...
	private:
		...
		*	note to self: this is an owning pointer
		*/
