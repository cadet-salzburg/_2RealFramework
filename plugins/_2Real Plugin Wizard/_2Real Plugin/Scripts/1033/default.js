...
function OnFinish(selProj, selObj)
{
	try
	{
	    ...
	    strProjectPath = strProjectPath.substr(0, strProjectPath.length - strProjectName.length);
	    strProjectPath = strProjectPath + '\\build\\vc10';
...
function CreateCustomProject(strProjectName, strProjectPath)
{
	try
	{
	    ...
	    var strProjTemplate = '';
        // where to look for the default...
		strProjTemplate = strProjTemplatePath + '\\build\\default.vcxproj';
...
function GetTargetName(strName, strProjectName)
{
	try
	{
		...
		if (strName == '/src/Plugin.h')
		    strTarget = '..\\..\\src\\Plugin.h';
		
        if (strName == '/src/ServiceImpl.cpp')
            strTarget = '..\\..\\src\\ServiceImpl.cpp';
        
        if(strName == '/src/ServiceImpl.h')
            strTarget = '..\\..\\src\\ServiceImpl.h';
